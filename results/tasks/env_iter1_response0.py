    ...
    * v0: Initial versions release
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Attributes needed for computing reward 
    ...
    def step(self, action):
        ...
        reward, reward_info = self.compute_reward(x_velocity, observation, action)
    ...
    def compute_reward(self, x_velocity: float,observation, action):
        self.rew_buf[:], self.rew_dict = reward_function(self,x_velocity, observation, action)
        self.extras['gpt_reward'] = self.rew_buf.mean() if len(self.rew_buf)>0 else 0
